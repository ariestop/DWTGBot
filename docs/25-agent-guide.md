...
Существующий английский текст переводится только вместе с содержательной
правкой раздела; массовый перевод без изменения смысла не делается — он
раздувает diff и рискует рассинхронизировать документы.
